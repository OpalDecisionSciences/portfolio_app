...
# Initialize S3 logging for production vector population from docs
...
if log_storage == 'S3':
    ...
    logger = logging.getLogger('docs_vector_population')
    ...
    s3_handler = S3LogHandler(log_bucket, log_prefix, 'docs_vector_population')
