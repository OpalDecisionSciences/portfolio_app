...
# Initialize S3 logging for production vector population from CSV
...
if log_storage == 'S3':
    ...
    logger = logging.getLogger('csv_vector_population')
    ...
    s3_handler = S3LogHandler(log_bucket, log_prefix, 'csv_vector_population')
